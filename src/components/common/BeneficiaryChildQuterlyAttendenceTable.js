...
function BeneficiaryChildQuterlyAttendenceTable() {
    ...
    <table class="table table-hover text-nowrap">
      <thead>
        ...
        <th style={{width:0}}>S.No.</th>
          ...
          <th class="text-center">
            <img
              src="dist/img/icon/height.png"
              alt="Height"
              class="img-size-32"
            />
            <p style={{ fontSize: 12 }}>Height</p>
            <div class="form-check" style={{ paddingBottom: 15 }}>
              <input class="form-check-input" type="checkbox" />
            </div>
          </th>
...
export default BeneficiaryChildQuterlyAttendenceTable;
